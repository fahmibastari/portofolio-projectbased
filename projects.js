...
const PROJECTS = {
    ...
    magicpin: {
        id: 'magicpin',
        name: 'Magic Pin Trading Ecosystem',
        category: 'Fullstack · AI · Mobile',
        desc: 'A massive, multi-repo digital ecosystem for Disney pin collectors and traders. Features an Android & iOS mobile app with AI-powered multi-scan capabilities (using PyTorch and Mask2Former for segmenting pin boards and removing backgrounds), a real-time messaging microservice built on Socket.io, and a custom interactive map engine using GDAL and Leaflet to render high-resolution Disneyland/Disney World map tiles. The web dashboard (React + Tailwind) allows admins to curate the pin catalog, approve trades, manage subscription tiers via PayPal, and view real-time platform analytics.',
        role: 'Fullstack Developer', timeline: '6 months', type: 'Collaborative Work',
        thumb: 'image/magicpin/Mobile - FullMapTiles.png',
        tech: [
            { name: 'NestJS', color: '#e0234e' },
            { name: 'React Native', color: '#61dafb' },
            { name: 'Python Flask', color: '#3776ab' },
            { name: 'PyTorch AI', color: '#ee4c2c' },
            { name: 'Socket.io', color: '#010101' },
            { name: 'GDAL Map', color: '#006400' },
            { name: 'PostgreSQL', color: '#336791' },
            { name: 'React', color: '#61dafb' },
            { name: 'TailwindCSS', color: '#38bdf8' },
        ],
        images: [
            { file: 'image/magicpin/Mobile - FullMapTiles.png', label: 'Mobile · Interactive Park Map' },
            { file: 'image/magicpin/DashboardGuest1.png', label: 'Mobile · Home Dashboard' },
            { file: 'image/magicpin/DashboardGuest2.png', label: 'Mobile · Social Trade Feed' },
            { file: 'image/magicpin/DashboardGuest3.png', label: 'Mobile · AI Multi-Scan Board' },
            { file: 'image/magicpin/DashboardGuest4.png', label: 'Mobile · AI Crop Results' },
            { file: 'image/magicpin/Mobile - List Map.png', label: 'Mobile · Park Locations List' },
            { file: 'image/magicpin/Mobile - Pin Detail.png', label: 'Mobile · Pin Details' },
            { file: 'image/magicpin/Mobile - Wishlist.png', label: 'Mobile · Wishlist & Collection' },
            { file: 'image/magicpin/Mobile - My Profile.png', label: 'Mobile · User Profile Collection' },
            { file: 'image/magicpin/Mobile - AccountSettings.png', label: 'Mobile · Settings Page' },
            { file: 'image/magicpin/Web - Map Tiles - List Map.png', label: 'Web · Custom Tiles Map Admin' },
            { file: 'image/magicpin/Web - Marketplace.png', label: 'Web · Marketplace Directory' },
            { file: 'image/magicpin/Web - My Profile - Board.png', label: 'Web · User Profile Collection Board' },
            { file: 'image/magicpin/Web - Detail Pin.png', label: 'Web · Pin Specs Details' },
        ],
    },

    spekhp: {
        id: 'spekhp',
        name: 'SpekHP Specs Portal',
        category: 'Custom CMS · Web Portal',
        desc: 'A GSMArena-style phone specifications portal designed for the Indonesian market. Built on Leaf MVC v4 (PHP 8.2+) with Eloquent ORM, this custom CMS features AJAX-powered autocomplete search, a dual-device specifications comparison engine, and a fully automated web scraper for GSMArena. The dashboard empowers administrators to manage devices, ad slots, and SEO metadata. Optimized for monetization and discoverability with Adsense slots, automated sitemaps, JSON-LD schema, and an integrated WordPress blog structure via .htaccess.',
        role: 'Fullstack Developer', timeline: '2.5 months', type: 'Client Work',
        thumb: 'image/spekhp/Main.png',
        tech: [
            { name: 'Leaf MVC', color: '#85c226' },
            { name: 'PHP', color: '#777bb4' },
            { name: 'TailwindCSS', color: '#38bdf8' },
            { name: 'Alpine.js', color: '#77c1d2' },
            { name: 'MySQL', color: '#4479a1' },
            { name: 'Eloquent ORM', color: '#f55247' },
            { name: 'Vite', color: '#a855f7' },
        ],
        images: [
            { file: 'image/spekhp/Main.png', label: 'Landing · Home' },
            { file: 'image/spekhp/Main2.png', label: 'Landing · Specs Detail' },
            { file: 'image/spekhp/Main3.png', label: 'Landing · Alternative View' },
            { file: 'image/spekhp/Dashboard-SearchHP.png', label: 'Portal · Search HP' },
            { file: 'image/spekhp/Dashboard-HPCompare.png', label: 'Portal · Compare HP' },
            { file: 'image/spekhp/Dashboard-AllBrand.png', label: 'Portal · Brand Categories' },
            { file: 'image/spekhp/Dashboard-AllCapture.png', label: 'Portal · All Features Capture' },
            { file: 'image/spekhp/Admin-Dashboard.png', label: 'Admin · Dashboard' },
            { file: 'image/spekhp/Admin-ManageBrands.png', label: 'Admin · Manage Brands' },
            { file: 'image/spekhp/Admin-ManageAds.png', label: 'Admin · Manage Ads' },
            { file: 'image/spekhp/Admin-ManageTestimonial.png', label: 'Admin · Manage Testimonial' },
        ],
    },
